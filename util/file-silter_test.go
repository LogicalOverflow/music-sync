...
func TestListAllSongs(t *testing.T) {
	songsDir1 := ListAllSongs(testDir, "dir1")
...
func TestListGlobSongs(t *testing.T) {
	songsDir1, err := ListGlobSongs(testDir, "dir1/*")
	...
	songs1Deep, err := ListGlobSongs(testDir, "*/*")
